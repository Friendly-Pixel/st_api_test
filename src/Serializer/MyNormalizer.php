...
class MyNormalizer extends ObjectNormalizer
{
    ...
    {
        if (false === $allowedAttributes = self::_getAllowedAttributes($classOrObject, $context, $attributesAsString)) {
            return false;
        }
        ...
        if (null !== $this->classDiscriminatorResolver) {
            ...
            if (null !== $discriminatorMapping = $this->classDiscriminatorResolver->getMappingForClass($class)) {
                ...
                foreach ($discriminatorMapping->getTypesMapping() as $mappedClass) {
                    $attributes[] = self::_getAllowedAttributes($mappedClass, $context, $attributesAsString);
                }
     ...
     */
    protected function _getAllowedAttributes(string|object $classOrObject, array $context, bool $attributesAsString = false): array|bool
    {
        ...
        foreach ($this->classMetadataFactory->getMetadataFor($classOrObject)->getAttributesMetadata() as $attributeMetadata) {
            ...
            $inGroup = ([] === $groups || array_intersect(array_merge($attributeMetadata->getGroups(), ['*']), $groups));
